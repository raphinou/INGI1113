...
28
normal! 0
lcd ~/etudes/os-ingi1113/ex1
wincmd w
argglobal
edit ~/etudes/os-ingi1113/ex1/str_buf.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
exe '1resize ' . ((&lines * 28 + 29) / 59)
exe '2resize ' . ((&lines * 27 + 29) / 59)
tabedit ~/etudes/os-ingi1113/ex1/str_buf.c
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
edit ~/etudes/os-ingi1113/ex1/str_buf.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((8 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
exe '1resize ' . ((&lines * 28 + 29) / 59)
exe '2resize ' . ((&lines * 27 + 29) / 59)
tabedit ~/etudes/os-ingi1113/ex1/Makefile
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
